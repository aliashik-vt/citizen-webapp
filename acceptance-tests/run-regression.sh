...
curl -sL -H "Authorization: token $(cat ~/.ssh/github_token)" https://github.com/dft-bluebadge/dev-env/archive/develop.tar.gz | tar xz
if [ $? -ne 0 ]; then
